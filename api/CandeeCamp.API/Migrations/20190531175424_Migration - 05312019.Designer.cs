...
namespace CandeeCamp.API.Migrations
{
    ...
    [Migration("20190531175424_Migration - 05312019")]
    partial class Migration05312019
    {
            ...
            modelBuilder.Entity("CandeeCamp.API.DomainObjects.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("71acd5ee-2325-4ea3-9c63-ee564f848e4e"),
                            DateCreated = new DateTimeOffset(new DateTime(2019, 5, 31, 13, 54, 23, 572, DateTimeKind.Unspecified).AddTicks(1520), new TimeSpan(0, -4, 0, 0, 0)),
